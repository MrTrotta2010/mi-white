...
CASCADES_FOLDER = "/home/trotta/opencv/data/haarcascades/"
MODELS_FOLDER = "/home/trotta/opencv_contrib/modules/saliency/samples/ObjectnessTrainedModel/"
...
def crop_image(image_path, out_path):
	...
	if not success:
		print("crop.py: erro: não foi possível calcular a saliência!")
		sys.exit(2)
